...
<div id="showVideoOptions"></div>
  <p><strong><span lang="es"><span><span>El coraz&oacute;n de Jes&uacute;s para todas las personas (Cruzando fronteras culturales) [32-45 d.C.]</span></span></span></strong></p>

<p>Este per&iacute;odo cubre alrededor de 12 a&ntilde;os de crecimiento y ministerio. Est&aacute; marcado por el cruce de nuevas fronteras culturales a medida que Jes&uacute;s gu&iacute;a a los creyentes a salir de Jerusal&eacute;n para hacer disc&iacute;pulos. La creaci&oacute;n de disc&iacute;pulos y la plantaci&oacute;n de iglesias se extendieron desde Jerusal&eacute;n, a Judea, a Samaria y al mundo gentil.</p>

<p>Cartas escritas durante este per&iacute;odo</p>

<ul>
	<li>Santiago, mediados de los a&ntilde;os 40</li>
</ul>
...
<table class="social">
	<tbody>
		<tr>
			...
			<td class="social" @click="share('lesson', 'Período 2: ', '/content/M2/spa/multiply3/multiply3intro2.html')">
