...
<div id="showVideoOptions"></div>
  <p><strong>Consecuencias de la explosi&oacute;n del Reino en Jerusal&eacute;n [30-32 d.C.]</strong></p>

<p style="text-align: justify;">Este per&iacute;odo abarca los primeros a&ntilde;os despu&eacute;s de la muerte, resurrecci&oacute;n y ascensi&oacute;n de Jes&uacute;s. Los ap&oacute;stoles designados comienzan a obedecer el mandamiento de hacer disc&iacute;pulos, pero no salieron de Jerusal&eacute;n. El per&iacute;odo est&aacute; marcado por el crecimiento explosivo, la persecuci&oacute;n, los milagros y las caracter&iacute;sticas fundamentales de la comunidad de creyentes.</p>
...
<table class="social">
	<tbody>
		<tr>
			...
			<td class="social" @click="share('lesson', 'Período 1: ', '/content/M2/spa/multiply3/multiply3intro1.html')">
