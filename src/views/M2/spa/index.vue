...
<div class="Xapp-link">
  <div class="card-link" @click="vuePush('spa-hope-index')">
    <div class="Xapp-card -Xshadow">
      <img src="@/assets/images/spa/custom/spanish-stories-of-hope.png" class="book-large" />
    </div>
  </div>
</div>
...
<!-- begin mc2 sdcard bookImage -->
<div class="Xapp-link">
  <div class="card-link" @click="vuePush('spa-multiply1-index')">
    <div class="Xapp-card -Xshadow">
      <img src="@/assets/images/spa/custom/spanish-called-by-jesus.png" class="book-large" />
    </div>
  </div>
</div>
<!-- end mc2 sdcard bookImage -->
<!-- begin mc2 sdcard bookImage -->
<div class="Xapp-link">
  <div class="card-link" @click="vuePush('spa-multiply2-index')">
    <div class="Xapp-card -Xshadow">
      <img src="@/assets/images/spa/custom/Spanish-multiply2.png" class="book-large" />
    </div>
  </div>
</div>
<!-- end mc2 sdcard bookImage -->
<!-- begin mc2 sdcard bookImage -->
<div class="Xapp-link">
  <div class="card-link" @click="vuePush('spa-multiply3-index')">
    <div class="Xapp-card -Xshadow">
      <img src="@/assets/images/spa/custom/spanish-sent-by-jesus.png" class="book-large" />
    </div>
  </div>
</div>
<!-- end mc2 sdcard bookImage -->
<!-- begin mc2 sdcard bookImage -->
<div class="Xapp-link">
  <div class="card-link" @click="vuePush('spa-tc-index')">
    <div class="Xapp-card -Xshadow">
      <img src="@/assets/images/spa/custom/spanish-transferable-concepst.png" class="book-large" />
    </div>
  </div>
</div>
<!-- end mc2 sdcard bookImage -->
...
<table class="social">
	<tbody>
		<tr>
			...
			<td class="social" @click="share('lesson', 'library: ', '/content/M2/spa/index.html')">
